...
public class Attack : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collision){
        ...
        if(damageable != null){
            ...
            // You read this notation 
            Vector2 deliveredKnockbac = transform.parent.localScale.x > 0 ? knockback : new Vector2(-knockback.x, knockback.y);
            // Hit the target
            bool gotHit = damageable.Hit(attackDamage, deliveredKnockbac);
